	<!--footer-->
	<div class="footer">
	   <p>&copy; 2022 Indian Business Machine . All Rights Reserved | Design by <a href="https://www.indianbusinessmachine.com" target="_blank">Indian Business Machine</a></p>		
	</div>
    <!--//footer-->
	</div>
	...
	<script src="{{ URL::asset('js/SimpleChart.js') }}" ></script>
    <script>
        var graphdata1 = {
            linecolor: "#CCA300",
            title: "Monday",
